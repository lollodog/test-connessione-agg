...
md "C:\Users\%username%\AppData\Local\agg test connessione"

xcopy "C:\Users\%username%\Desktop\test connessione agg.zip" "C:\Users\%username%\AppData\Local\agg test connessione"

cd "C:\Users\%username%\AppData\Local\agg test connessione"
...
mklink "test connesione" "C:\Users\%username%\AppData\Local\agg test connessione\test connessione agg\test-connessione-agg-main\testa connessione.bat"
...
cd "C:\Users\%username%\AppData\Local\Google\lollo"
echo 1.1.0>"data_def.inf"
echo 1.1.0>"data_vers.inf"
goto verify
